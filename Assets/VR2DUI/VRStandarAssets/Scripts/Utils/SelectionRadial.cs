...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        public bool m_Full2DUI;                                                                 // Gaze based plus click and double click for interaction (no selection bar filling)
        public bool m_Simple2DUI;                                                               // Gaze based plus click to fill selection bar
        public bool m_GazeBased;                                                                // Gaze based only interaction

        public Coroutine m_SelectionFillRoutine;                                                // Used to start and stop the filling coroutine based on input.
